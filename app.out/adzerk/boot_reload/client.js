...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__11782,opts){
var map__11783 = p__11782;
var map__11783__$1 = ((((!((map__11783 == null)))?((((map__11783.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11783.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11783):map__11783);
var files = cljs.core.get.call(null,map__11783__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___11789 = arguments.length;
var i__6153__auto___11790 = (0);
while(true){
if((i__6153__auto___11790 < len__6152__auto___11789)){
args__6159__auto__.push((arguments[i__6153__auto___11790]));

var G__11791 = (i__6153__auto___11790 + (1));
i__6153__auto___11790 = G__11791;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__11787){
var vec__11788 = p__11787;
var opts = cljs.core.nth.call(null,vec__11788,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__11788,opts){
return (function (evt){
...
});})(conn,vec__11788,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__11788,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__11788,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__11788,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq11785){
var G__11786 = cljs.core.first.call(null,seq11785);
var seq11785__$1 = cljs.core.next.call(null,seq11785);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__11786,seq11785__$1);
});
