...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__11759,opts){
...
var files = cljs.core.get.call(null,map__11760__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___11766 = arguments.length;
var i__6153__auto___11767 = (0);
while(true){
if((i__6153__auto___11767 < len__6152__auto___11766)){
args__6159__auto__.push((arguments[i__6153__auto___11767]));

var G__11768 = (i__6153__auto___11767 + (1));
i__6153__auto___11767 = G__11768;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__11764){
var vec__11765 = p__11764;
var opts = cljs.core.nth.call(null,vec__11765,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__11765,opts){
return (function (evt){
...
});})(conn,vec__11765,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__11765,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__11765,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__11765,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq11762){
var G__11763 = cljs.core.first.call(null,seq11762);
var seq11762__$1 = cljs.core.next.call(null,seq11762);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__11763,seq11762__$1);
});
