...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__12126,opts){
...
var files = cljs.core.get.call(null,map__12127__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__6152__auto___12133 = arguments.length;
var i__6153__auto___12134 = (0);
while(true){
if((i__6153__auto___12134 < len__6152__auto___12133)){
args__6159__auto__.push((arguments[i__6153__auto___12134]));

var G__12135 = (i__6153__auto___12134 + (1));
i__6153__auto___12134 = G__12135;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__12131){
var vec__12132 = p__12131;
var opts = cljs.core.nth.call(null,vec__12132,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__12132,opts){
return (function (evt){
...
});})(conn,vec__12132,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__12132,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__12132,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__12132,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq12129){
var G__12130 = cljs.core.first.call(null,seq12129);
var seq12129__$1 = cljs.core.next.call(null,seq12129);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__12130,seq12129__$1);
});
